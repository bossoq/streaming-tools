...
export const twitchClient = async () => {
  ...
  chatClient.onRaid((channel, user, raidInfo) => {
    console.log(`${channel} ${user} raid ${{ ...raidInfo }}`)
  })
  return chatClient
}
