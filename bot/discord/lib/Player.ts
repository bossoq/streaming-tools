...
export class Player {
  ...
  protected _createQueue(
    ...
    message
      ...
      .setURL(track.url!)
      .setAuthor({ name: 'Queue Added!', iconURL: youtubeImg })
  ...
  getQueue(interaction: ExtendsInteraction): void | boolean {
    ...
    if (!q) {
      ...
      message
        .setTitle('Song Queue')
        .setAuthor({ name: 'Sniifsbot Youtube Player', iconURL: youtubeImg })
      interaction.reply({
        embeds: [message],
        ephemeral: true
      })
    ...
    if (
      ...
      if (!videos) {
        ...
        message
          ...
          .setAuthor({ name: 'Sniffsbot Search Result', iconURL: youtubeImg })
  ...
  protected _playTrack(queue: Queue): void | boolean {
    ...
    if (queue.tracks[0].url) {
      ...
      message
        ...
        .setAuthor({ name: 'Now Playing!', iconURL: youtubeImg })
